...
const dictionaries: Record<Locale, Dict> = {
    ...
    en: {
        ...
        'OVO': 'OVO',
        'DANA': 'DANA',
        'QRIS, VA Bank, GoPay, dan metode lainnya': 'QRIS, virtual account, GoPay, and other methods',
        ...
        'Pembayaran otomatis via Midtrans': 'Automatic payment',
        'Pembayaran akan diarahkan ke halaman Midtrans untuk menyelesaikan transaksi secara otomatis.':
            'Payment will redirect to the payment page to complete the transaction automatically.',
        ...
        'Integrasi Tripay sedang dimatikan lewat konfigurasi aplikasi.':
            'This payment integration is currently disabled through the application configuration.',
        'Log Aktivitas': 'Activity logs',
        'Log Aktivitas User': 'User activity logs',
        'Medanpedia': 'Medanpedia',
        'Midtrans': 'Midtrans',
        'Tripay': 'Tripay',
        ...
        'Admin dapat menambah, mengurangi, atau set saldo user secara manual.':
            "Admins can add, subtract, or set a user's balance manually.",
        'Akun yang dibuat lewat admin otomatis dianggap sudah verifikasi email.':
            'Accounts created by admins are considered email-verified.',
        'Arah': 'Direction',
        'Atur Saldo': 'Adjust balance',
        'Atur Ulang': 'Reset',
        'Bank BCA': 'BCA Bank',
        'Bank BNI': 'BNI Bank',
        'Bank BRI': 'BRI Bank',
        ...
        'Cek Status Terakhir': 'Check latest status',
        'Checkout URL': 'Checkout URL',
        'Comments': 'Comments',
        'contoh: penyesuaian manual': 'e.g. manual adjustment',
        'Daftar email admin dari allowlist.': 'List of admin emails from the allowlist.',
        'Daftar saran dari pengguna.': 'List of user suggestions.',
        'dari': 'from',
        'Data channel tidak tersedia.': 'Channel data is unavailable.',
        'Debit': 'Debit',
        'Detail Pengguna': 'User details',
        'Detail Saran': 'Suggestion details',
        'Dicek Pada': 'Checked at',
        'Diperbarui': 'Updated',
        'Edit': 'Edit',
        'Edit Data': 'Edit data',
        ...
        'Gabungan aktivitas semua user.': 'Combined activity of all users.',
        'Hapus': 'Delete',
        'Hapus data laporan keuangan ini?': 'Delete this financial report record?',
        'Hapus user ini? Data terkait (order/deposit) ikut terhapus.':
            'Delete this user? Related data (orders/deposits) will be deleted too.',
        'Harga': 'Price',
        'HP': 'Phone',
        'IP': 'IP',
        'Jumlah (Rp)': 'Amount (Rp)',
        'Jumlah Percobaan Cek Status': 'Status check attempts',
        'Kelola laporan keuangan harian seperti SMM-Panel.':
            'Manage daily financial reports like SMM-Panel.',
        'Keluhan': 'Complaint',
        'Keterangan': 'Description',
        'Kirim': 'Send',
        'Kirim saran atau keluhan Anda.': 'Send your suggestion or complaint.',
        'Kode': 'Code',
        'Kolom': 'Column',
        'Konfirmasi': 'Confirm',
        ...
        'Kredit': 'Credit',
        'Kurangi': 'Subtract',
        'Manajemen deposit admin.': 'Admin deposit management.',
        'Manajemen layanan admin.': 'Admin service management.',
        'Manajemen pengguna admin.': 'Admin user management.',
        'Manajemen pesanan admin.': 'Admin order management.',
        'Markup (Rp)': 'Markup (Rp)',
        'Markup Harga': 'Price markup',
        'Max': 'Max',
        'Menampilkan': 'Showing',
        'Mengirim...': 'Sending...',
        'Mode': 'Mode',
        'Mutasi Saldo': 'Balance mutations',
        'Nama / Email / Telepon Pengguna': 'User name / email / phone',
        'Nama / Email Pengguna': 'User name / email',
        'nama / kategori / kode': 'name / category / code',
        'Nama Pengguna / Layanan': 'User / service name',
        'Nama User': 'User name',
        'Nilai': 'Value',
        'Nilai ini akan ditambahkan ke harga layanan (per 1000).':
            'This value will be added to the service price (per 1000).',
        'Nomor HP/WA': 'Phone/WhatsApp number',
        'Partial': 'Partial',
        'Password': 'Password',
        'Pending': 'Pending',
        'Perbarui Status': 'Update status',
        'Pesan': 'Message',
        'pesan / entity / admin': 'message / entity / admin',
        'Pesanan': 'Orders',
        'Pilih tanggal': 'Choose date',
        'Processed': 'Processed',
        'Profil tidak tersedia.': 'Profile is unavailable.',
        'Proses': 'Process',
        'Provider Order ID': 'Provider Order ID',
        'Provider Payload': 'Provider payload',
        'Rentang Tanggal': 'Date range',
        'Riwayat aktivitas di area admin.': 'Activity history in the admin area.',
        'Riwayat perubahan saldo.': 'Balance change history.',
        'Saldo Customer': 'Customer balance',
        'Saldo Customer (Total)': 'Customer balance (total)',
        'Saldo DANA': 'DANA balance',
        'Saldo GOJEK': 'GOJEK balance',
        'Saldo Medanpedia': 'Medanpedia balance',
        'Saldo OVO': 'OVO balance',
        'Saran': 'Suggestion',
        'Saran berhasil dikirim.': 'Suggestion sent successfully.',
        'Sebelum': 'Before',
        'Selisih': 'Difference',
        'Sesudah': 'After',
        'Set Saldo': 'Set balance',
        'Status koneksi & integrasi.': 'Connection & integration status.',
        'Status sukses hanya bisa diset dari pending, dan tidak bisa diturunkan.':
            'Success status can only be set from pending and cannot be downgraded.',
        'Sukses': 'Success',
        'Sumber': 'Source',
        ...
        'Total Keuangan': 'Total finance',
        'Total Pengguna': 'Total users',
        'Total Piutang': 'Total receivables',
        'Total Saldo': 'Total balance',
        'Total Spent': 'Total spent',
        'Tripay Merchant Ref': 'Tripay merchant ref',
        'Tripay Pay Code': 'Tripay pay code',
        'Tripay Reference': 'Tripay reference',
        'Tulis saran Anda...': 'Write your suggestion...',
        'Uang Cash': 'Cash',
        'Update Oleh': 'Updated by',
        'User': 'User',
        'Ya, hapus': 'Yes, delete',
        'Contoh: 08xxxxxxxxxx': 'Example: 08xxxxxxxxxx',
        'Silakan masuk untuk mengirim saran melalui form Kotak Saran.':
            'Please log in to send suggestions via the Suggestion Box form.',
        ...
        'User ID': 'User ID',
        'Kata kunci': 'Keyword',
        'contoh: login / order / email': 'e.g. login / order / email',
        'Isi Saldo': 'Top up',
        ...
        'Tripay dinonaktifkan sementara': 'Payment method is temporarily disabled',
        'Metode QRIS dan E-Wallet dari Tripay untuk sementara tidak tersedia saat proses migrasi ke Midtrans.':
            'QRIS and e-wallet methods are temporarily unavailable during the payment update process.',
