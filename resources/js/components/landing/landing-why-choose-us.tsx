            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-8">
                <div>
                    <h2 className="text-balance text-2xl font-semibold tracking-tight sm:text-3xl">
                        Kenapa pilih AcisPedia?
                    </h2>
                    <p className="mt-3 text-pretty text-muted-foreground">
                        AcisPedia adalah platform SMM (Social Media Marketing)
                        yang membantu Anda meningkatkan jangkauan dan kredibilitas
                        akun secara mudah. Dengan sistem otomatis, pesanan diproses
                            ...
                            <div className="grid gap-4">
                                <div className="rounded-lg border bg-card p-4">
                                    <div className="text-sm font-medium">
                                        Struktur layanan jelas
                                    </div>
                                    <div className="mt-1 text-sm text-muted-foreground">
                                        Pilih kategori, tentukan target, dan pantau
                                        status dalam satu alur.
                                    </div>
                                </div>
                                <div className="rounded-lg border bg-card p-4">
                                    <div className="text-sm font-medium">
                                        Monitoring yang rapi
                                    </div>
                                    <div className="mt-1 text-sm text-muted-foreground">
                                        Update status dan riwayat pesanan mudah
                                        dicari kapan saja.
                                    </div>
                                </div>
                            </div>
